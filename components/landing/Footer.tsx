...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#05070f] border-t-[0.5px] border-[var(--border)] pb-8 text-[var(--text-secondary)] w-full">
      {/* Navigation Section */}
      <div
        className="grid max-w-[1400px] mx-auto pt-[72px] px-[64px] gap-[72px] items-start w-full"
      ...
      {/* Divider */}
      <div className="max-w-[1400px] mx-auto px-[64px] mt-[72px]">
        <div className="border-t-[0.5px] border-[var(--border)] opacity-30 w-full" />
      </div>

      {/* Statistics Row */}
      <div className="max-w-[1400px] mx-auto px-[64px] mt-[48px] flex justify-between items-center w-full">
      ...
      {/* Campus Illustration */}
      <div className="w-full overflow-hidden mt-[50px] select-none pointer-events-none">
        <img
      ...
      {/* Bottom Bar Divider */}
      <div className="max-w-[1400px] mx-auto px-[64px]">
        <div className="border-t-[0.5px] border-[rgba(255,255,255,0.06)] w-full" />
      </div>

      {/* Bottom Bar Content */}
      <div className="max-w-[1400px] mx-auto px-[64px] py-6 flex flex-col lg:flex-row items-center justify-between gap-4 text-[11px] text-[var(--text-muted)]">
        {/* Left: Taglines */}
