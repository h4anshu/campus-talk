...
-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('DISCUSSION', 'SPACE');

-- CreateEnum
CREATE TYPE "SpaceType" AS ENUM ('ANNOUNCEMENTS', 'EVENTS', 'RESOURCES', 'LOST_FOUND', 'COLLABORATION', 'CONFESSION');

-- CreateEnum
CREATE TYPE "TopicType" AS ENUM ('ACADEMICS', 'ASSIGNMENT', 'PLACEMENTS', 'INTERNSHIP', 'CODING', 'PROJECTS', 'HOSTEL_MESS', 'EVENTS', 'GENERAL');

-- CreateEnum
CREATE TYPE "PostStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'REMOVED');
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_collegeId_fkey" FOREIGN KEY ("collegeId") REFERENCES "College"("id") ON DELETE SET NULL ON UPDATE CASCADE;
